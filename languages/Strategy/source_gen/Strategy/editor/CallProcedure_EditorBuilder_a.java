...
/*package*/ class CallProcedure_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CallProcedure_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5bxcp7_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_5bxcp7_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_5bxcp7_a0a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.calls$qn3g;
    ...
    provider.setNoTargetText("<no calls>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.calls$qn3g);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_5bxcp7_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new argsListHandler_5bxcp7_d0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_args");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class argsListHandler_5bxcp7_d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argsListHandler_5bxcp7_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.args$qssB;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.CoreAsset$kT;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argsListHandler_5bxcp7_d0a.this.getNode(), LINKS.args$qssB));
      try {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_5bxcp7_e0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink args$qssB = MetaAdapterFactory.getContainmentLink(0x373945843af4b09L, 0x880a7168a8fb745aL, 0x3416b497162b2bacL, 0x47ee70901066f750L, "args");
  }
